...
const blockList: Block[] = [
  ...
  // ======================================================================
  block('15', '47', {
    bbox: { x: 0.258, y: 0.352, w: 0.065, h: 0.030 },
...
Is check satisfactory?`,
  ...
  block('15', '49', {
    bbox: { x: 0.658, y: 0.352, w: 0.065, h: 0.030 },
  ...
  block('15', '50', {
    bbox: { x: 0.658, y: 0.548, w: 0.065, h: 0.030 },
  ...
  // ======================================================================
  block('17', '52', {
    bbox: { x: 0.030, y: 0.122, w: 0.055, h: 0.028 },
...
Is RPM for propeller under test between 99.8 and 100.2 percent?`,
  ...
  block('17', '53', {
    bbox: { x: 0.030, y: 0.282, w: 0.055, h: 0.028 },
...
Is index satisfactory?`,
  ...
  block('17', '54', {
    bbox: { x: 0.030, y: 0.425, w: 0.055, h: 0.028 },
  ...
  block('17', '55', {
    bbox: { x: 0.030, y: 0.570, w: 0.055, h: 0.028 },
...
Is RPM stable?`,
  ...
  block('17', '56', {
    bbox: { x: 0.278, y: 0.570, w: 0.065, h: 0.028 },
    text: `Perform synchrophaser index in accordance with TO 1C-130H-2-61JG-10-1, 61-10-02 (subtask 1-2-6).
Is RPM stable in normal governing mode after index?`,
  ...
  block('17', '57', {
    bbox: { x: 0.572, y: 0.118, w: 0.075, h: 0.028 },
  ...
  block('17', '58', {
    bbox: { x: 0.572, y: 0.258, w: 0.075, h: 0.028 },
  ...
  block('17', '59', {
    bbox: { x: 0.572, y: 0.570, w: 0.075, h: 0.028 },
  ...
  block('17', '60', {
    bbox: { x: 0.572, y: 0.728, w: 0.075, h: 0.028 },
  ...
  // ======================================================================
  block('19', '61', {
    bbox: { x: 0.028, y: 0.100, w: 0.060, h: 0.028 },
...
Was a pitchlock obtained?`,
  ...
  block('19', '64', {
    bbox: { x: 0.615, y: 0.390, w: 0.075, h: 0.028 },
  ...
  // ======================================================================
  block('21', '65', {
    bbox: { x: 0.028, y: 0.120, w: 0.060, h: 0.028 },
  ...
  block('21', '66', {
    bbox: { x: 0.028, y: 0.272, w: 0.060, h: 0.028 },
...
Do propeller low pitch stops retract as indicated by a decrease on engine torque indicators (1)?`,
  ...
  block('21', '67', {
    bbox: { x: 0.028, y: 0.480, w: 0.060, h: 0.028 },
...
2. Is NTS light (2) on?`,
  ...
  block('21', '70', {
    bbox: { x: 0.605, y: 0.710, w: 0.075, h: 0.028 },
